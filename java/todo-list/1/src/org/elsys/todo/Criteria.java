...
public interface Criteria {
	...
	public static Criteria status(Status status) {
		return new StatusCriteria(status); // Статичен метод за създаване на критерия отговаряща на подадения статус
	}
	...
	public static Criteria priority(Priority priority) {
		return new PriorityCriteria(priority);// Статичен метод за създаване на критерия отговаряща на подадения приоритет
	}
	...
	public static Criteria tags(String[] tags) {
		return new TagsCriteria(tags);// Статичен метод за създаване на критерия отговаряща на подадените тагове
	}
